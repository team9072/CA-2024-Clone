...
public class DiffDrivetrain extends Subsystem {
  ...
  private static DiffDrivetrain mInstance;
  private static PeriodicIO mPeriodicIO;

  public static DiffDrivetrain getInstance() {
    if (mInstance == null) {
      mInstance = new DiffDrivetrain();
    }
    return mInstance;
  }
  ...
  public DiffDrivetrain() {
    ...
    mSysIdRoutine = new SysIdRoutine(
      ...
      throw new UnsupportedOperationException("Legacy code for reference only, do not instantiate");
  }
